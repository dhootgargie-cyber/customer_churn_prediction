...
## Dataset
IBM Telco Customer Churn sample data: 7,043 customers, 21 features ([source](https://github.com/IBM/telco-customer-churn-on-icp4d)).
...
3. Trained XGBoost and compared it against a logistic regression baseline
4. Evaluated with ROC-AUC, precision, recall, and 5-fold cross-validation
5. Handled class imbalance with `scale_pos_weight`
6. Explained predictions with SHAP
